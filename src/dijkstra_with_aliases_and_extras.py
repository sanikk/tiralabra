...
def dijkstra(graph: Graph, start, end=-1, GUI=Mock_Gui()):
    # setup the lists for handled, distances, and heap
    ...
    # aliases to speed things up -> less lookups and they are in local scope -- TODO TEST THIS!!
    ...
    while len(heap) > 0:
        ...
        if end != -1 and vertex == end:
            # this is shortest distance, if there was a shorter way it would have been popped already
